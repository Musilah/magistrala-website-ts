...
The CLI for interacting with users are described in the [Users CLI](/docs/dev-guide/cli/users-cli).
...
The CLI for interacting with groups are described in the [Groups CLI](/docs/dev-guide/cli/groups-cli).
