...
For more information about the Users service API, please check out the [API documentation](https://docs.supermq.absmach.eu/api/#users).
...
For more information about the Clients service API, please check out the [API documentation](https://docs.supermq.absmach.eu/api/#clients).
